...
public class CircularStatisticsView extends View {
     ...
     * 第一圈圆环的颜色
     */
    private int mRingColor = R.color.colorRedNormal;
    /**
     * 第二圈的颜色
     */
    private int mSectorColor = R.color.colorMainTwo;
    /**
     * 终点扇形角度
     */
     ...
     * 剩余文字
     */
    private String reminderText = "錯題數";
    private int reminderNum;
    /**
     * 进度文字
     */
    private String progressText = "正確數";
    ...
    protected void onDraw(Canvas canvas) {
        ...
        // 设置外圆的颜色
        mPaint.setColor(ColorUtils.getColor(mRingColor));
        ...
        // 设置内圆的颜色
        mPaint.setColor(ColorUtils.getColor(R.color.colorWhite));
        ...
        // 设置画笔颜色
        mTextPaint.setColor(ColorUtils.getColor(mSectorColor));
//        drawText(canvas, progressText + getPer(mSweepAngle, 360), textX1, textY1, mTextPaint);
        drawText(canvas, progressText + "：" + progressNum, textX1, textY1, mTextPaint);
        // 获取进度圆弧的中心点
        ...
        // 设置画笔颜色
        mTextPaint.setColor(ColorUtils.getColor(mRingColor));
//        drawText(canvas, reminderText + getPer(360 - mSweepAngle, 360), textX2, textY2, mTextPaint);
        drawText(canvas, reminderText + "：" + reminderNum, textX2, textY2, mTextPaint);
    }
    ...
    private void getSectorClip(Canvas canvas, float startAngle) {
        // 进度的颜色
        mPaint.setColor(ColorUtils.getColor(mSectorColor));
        Path path = new Path();
        // 以下获得一个三角形的裁剪区
        // 圆心
    ...
    public void setPercentage(float ring, float sector) {
        reminderNum = (int) ring;
        progressNum = (int) sector;
