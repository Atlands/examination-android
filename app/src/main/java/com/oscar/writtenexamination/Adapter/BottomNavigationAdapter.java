...
import com.oscar.writtenexamination.Enums.BottomNavigationTab;
...
public class BottomNavigationAdapter extends RecyclerView.Adapter {
    ...
    private RegularTabViewHolder chatHolder;
    private int chatNum = 0;

    public BottomNavigationAdapter(Context context, BottomNavigationListener listener, int selectedPosition) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        if (viewType == REGULAR_ITEM_VIEW_TYPE) {
            View view = inflater.inflate(R.layout.item_bottom_tab_navigation_regular, parent, false);
...
//                    UIUtils.getDimension(R.dimen.bottom_navigation_clickable_area);
            ...
            View view = inflater.inflate(R.layout.item_bottom_tab_navigation_special, parent, false);
            RecyclerView.LayoutParams lp = (RecyclerView.LayoutParams) view.getLayoutParams();
            lp.width = width;
//            lp.topMargin = UIUtils.getDimension(R.dimen.bottom_navigation_view_height) -
//                    UIUtils.getDimension(R.dimen.bottom_navigation_clickable_area);
    ...
    class RegularTabViewHolder extends RecyclerView.ViewHolder {
        ...
        RegularTabViewHolder(View itemView) {
            super(itemView);
            iconIV = itemView.findViewById(R.id.ibtnrImg);
            titleTV = itemView.findViewById(R.id.ibtnrTv);
